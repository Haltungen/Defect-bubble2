...
Gamma_k = ops.GBiPeriodic(k, x1-y(1), x2-y(2), 1, 1, alpha);
Gamma_kb = ops.GBiPeriodic(k_b, x1-y(1), x2-y(2), 1, 1, alpha);
Gamma_k_nu = dot([cos(theta);sin(theta)],ops.GradGBiPeriodic(k, x1-y(1), x2-y(2), 1, 1, alpha));
Gamma_kb_nu = dot([cos(theta);sin(theta)],ops.GradGBiPeriodic(k_b, x1-y(1), x2-y(2), 1, 1, alpha));
F1 = Gamma_k - Gamma_kb;
